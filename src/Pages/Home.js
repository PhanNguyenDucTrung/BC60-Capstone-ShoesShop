                ...
                {arrProduct.length > 0 && (
                    <div className='col-12'>
                        <div className='d-flex align-items-center justify-content-center'>
                            <div className='col-6'>
                                <img src={arrProduct[1].image} className='w-100' alt='Product' />
                            </div>
                            <div className='col-6 des'>
                                <h2 className='h_h2 '>{arrProduct[1].name}</h2>
                                <p>{arrProduct[1].description}</p>
                                <div className=''>
                                    <NavLink to={`/detail/${arrProduct[1].id}`} className='btn btn-dark mr-5'>
                                        BUY NOW
                                    </NavLink>
                                </div>
                            </div>
                        ...
                        <div className='col-3 mt-5' key={prod.id}>
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    ...
                                    <p>${prod.price}</p>
                                    <NavLink to={`/detail/${prod.id}`} className='btn btn-dark mr-5'>
                                        BUY NOW
                                    </NavLink>
                                </div>
                            </div>
