                ...
                <div className='col-12'>
                    <div className='d-flex align-items-center justify-content-center'>
                        ...
                        <div className='col-6 des'>
                            ...
                            <button className='btnChange' onClick={increaseQuantity}>
                                +
                            </button>
                            <span className='number'>{quantity}</span>
                            <button className='btnChange ' onClick={decreaseQuantity}>
                                -
                            </button>
                            <br />
                            <button className='btnAddToCart mt-2' onClick={handleAddToCart}>
                                ADD TO CART
                            </button>
                            <AlertModal
                                visible={showAlert}
                        ...
                        <div className='col-4' key={prod.id}>
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    ...
                                    <p>{prod.price} $</p>
                                    <NavLink to={`/detail/${prod.id}`} className='btn btn-primary'>
                                        Detail
                                    </NavLink>
                                </div>
                            </div>
